...
--2. Find out the absolute value of -25, 25, -50 and 50.
	SELECT
		ABS(-25),ABS(25),ABS(-50),ABS(50)

--3. Find smallest integer value that is greater than or equal to 25.2, 25.7 and -25.2.
	SELECT 
		CEILING(25.2),CEILING(25.7),CEILING(-25.2)
...
--5. Find out remainder of 5 divided 2 and 5 divided by 3.
	SELECT 
		5 % 2 AS REMAINDER_5DIVIDED_2
	SELECT
		2 % 5 AS REMAINDER_2DIVIDED_5
...
--13. Find out logarithm having base b having value 10 of 5 and 100.
	SELECT
		LOG(10,10),LOG(100,5),LOG(10,100)

--14. Find sine, cosine and tangent of 3.1415.
	SELECT
		SIN(3.1415),COS(3.1415),TAN(3.1415)
...
--2. Display your name in lower & upper case.
	SELECT 
		LOWER('JASMIN') AS LOWER_NAME,
		UPPER('jasmin') AS UPPER_NAME

--3. Display first three characters of your name.
	SELECT
		LEFT('JASMIN',3) AS THREE_CHAR_NAME 
...
--12. Write a query to convert a float 10.58 to integer (Use cast and convert function).
	SELECT 
		CAST(10.58 AS INT) AS 'CAST',
		CONVERT(INT,10.58) AS 'CONVERT'
...
--16. Repeat your name 3 times.
	SELECT 
		REPLICATE('JASMIN',3) AS REPEAT_NAME 
